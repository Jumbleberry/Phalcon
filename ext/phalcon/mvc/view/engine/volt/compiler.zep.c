...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, functionCall)
{
	...
	if (ZEPHIR_IS_LONG(&nameType, 265)) {
		...
		ZEPHIR_CALL_FUNCTION(&method, "lcfirst", NULL, 66, &_8$$5);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&_10, this_ptr, "expression", NULL, 381, &nameExpr);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, expression)
{
	...
	while (1) {
		...
		if (!(zephir_array_isset_string_fetch(&type, &expr, SL("type"), 0))) {
			...
			if (Z_TYPE_P(&expr) == IS_ARRAY) {
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&expr), _3$$6)
				{
					...
					ZEPHIR_CALL_METHOD(&singleExprCode, this_ptr, "expression", &_6, 381, &_5$$7);
					zephir_check_call_status();
					ZEPHIR_OBS_NVAR(&name);
				...
				while (1) {
					...
					zephir_check_call_status();
						...
						ZEPHIR_CALL_METHOD(&singleExprCode, this_ptr, "expression", &_6, 381, &_8$$10);
						zephir_check_call_status();
						ZEPHIR_OBS_NVAR(&name);
						if (zephir_array_isset_string_fetch(&name, &singleExpr, SL("name"), 0)) {
		...
		if (zephir_array_isset_string_fetch(&left, &expr, SL("left"), 0)) {
			ZEPHIR_CALL_METHOD(&leftCode, this_ptr, "expression", &_6, 381, &left);
			zephir_check_call_status();
		}
		...
		if (ZEPHIR_IS_LONG(&type, 124)) {
			...
			ZEPHIR_CALL_METHOD(&exprCode, this_ptr, "resolvefilter", &_14, 386, &_13$$16, &leftCode);
			zephir_check_call_status();
			break;
		}
		ZEPHIR_OBS_NVAR(&right);
		if (zephir_array_isset_string_fetch(&right, &expr, SL("right"), 0)) {
			ZEPHIR_CALL_METHOD(&rightCode, this_ptr, "expression", &_6, 381, &right);
			zephir_check_call_status();
		}
		ZEPHIR_INIT_NVAR(&exprCode);
		ZVAL_NULL(&exprCode);
		do {
			...
			if (ZEPHIR_IS_LONG(&type, 365)) {
				...
				if (zephir_array_isset_string_fetch(&start, &expr, SL("start"), 0)) {
					ZEPHIR_CALL_METHOD(&startCode, this_ptr, "expression", &_6, 381, &start);
					zephir_check_call_status();
				} else {
				...
				if (zephir_array_isset_string_fetch(&end, &expr, SL("end"), 0)) {
					ZEPHIR_CALL_METHOD(&endCode, this_ptr, "expression", &_6, 381, &end);
					zephir_check_call_status();
				} else {
			...
			if (ZEPHIR_IS_LONG(&type, 366)) {
				...
				ZEPHIR_CALL_METHOD(&_21$$72, this_ptr, "expression", &_6, 381, &_22$$72);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&exprCode);
			...
			ZEPHIR_CALL_METHOD(NULL, &_23$$76, "__construct", &_27, 383, &_26$$76);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileForeach)
{
	...
	ZEPHIR_CALL_METHOD(&code, this_ptr, "_statementlist", NULL, 387, &blockStatements, &_4);
	zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&ifExpr, &statement, SL("if_expr"), 0)) {
		ZEPHIR_CALL_METHOD(&_16$$17, this_ptr, "expression", NULL, 381, &ifExpr);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileSwitch)
{
	...
	if (zephir_array_isset_string_fetch(&caseClauses, &statement, SL("case_clauses"), 0)) {
		...
		if (zephir_fast_strlen_ev(&lines) != 0) {
			...
			ZEPHIR_INIT_VAR(&_5$$5);
			ZVAL_STRING(&_5$$5, "");
			ZEPHIR_CALL_FUNCTION(&_6$$5, "preg_replace", NULL, 39, &_4$$5, &_5$$5, &lines);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileSet)
{
	...
	if (Z_TYPE_P(&assignments) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&assignments), _0)
		{
			...
			ZEPHIR_CALL_METHOD(&exprCode, this_ptr, "expression", &_3, 381, &_2$$4);
			zephir_check_call_status();
			...
			ZEPHIR_CALL_METHOD(&target, this_ptr, "expression", &_3, 381, &_4$$4);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&exprCode, this_ptr, "expression", &_3, 381, &_11$$10);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&target, this_ptr, "expression", &_3, 381, &_12$$10);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileMacro)
{
		...
		if (Z_TYPE_P(&parameters) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&parameters), _7$$6, _8$$6, _5$$6)
			{
				...
				if (zephir_array_isset_string_fetch(&defaultValue, &parameter, SL("default"), 0)) {
					ZEPHIR_CALL_METHOD(&_13$$8, this_ptr, "expression", &_14, 381, &defaultValue);
					zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					ZEPHIR_OBS_NVAR(&defaultValue);
					if (zephir_array_isset_string_fetch(&defaultValue, &parameter, SL("default"), 0)) {
						ZEPHIR_CALL_METHOD(&_21$$11, this_ptr, "expression", &_14, 381, &defaultValue);
						zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&blockStatements, &statement, SL("block_statements"), 0)) {
		...
		ZEPHIR_CALL_METHOD(&_24$$13, this_ptr, "_statementlist", NULL, 387, &blockStatements, &_25$$13);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(&statements) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&statements), _1)
		{
			...
			if (!(zephir_array_isset_string(&statement, SL("type")))) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_3$$7, "__construct", &_7, 383, &_6$$7, &statement);
				zephir_check_call_status();
			...
			if (Z_TYPE_P(&extensions) == IS_ARRAY) {
				...
				ZEPHIR_CALL_METHOD(&tempCompilation, this_ptr, "fireextensionevent", &_10, 382, &_9$$8, &_8$$8);
				zephir_check_call_status();
			...
			do {
				...
				if (ZEPHIR_IS_LONG(&type, 307)) {
					...
					if (zephir_is_true(&blockMode)) {
						...
						if (Z_TYPE_P(&blockStatements) == IS_ARRAY) {
							...
							ZEPHIR_CALL_METHOD(&_31$$24, this_ptr, "_statementlist", &_33, 387, &blockStatements, &_32$$24);
							zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(NULL, &_57$$38, "__construct", &_7, 383, &_60$$38);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (!(zephir_array_isset_string(&statement, SL("type")))) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_61$$41, "__construct", &_7, 383, &_64$$41, &statement);
					zephir_check_call_status();
				...
				if (Z_TYPE_P(&extensions) == IS_ARRAY) {
					...
					ZEPHIR_CALL_METHOD(&tempCompilation, this_ptr, "fireextensionevent", &_10, 382, &_66$$42, &_65$$42);
					zephir_check_call_status();
					if (Z_TYPE_P(&tempCompilation) == IS_STRING) {
						zephir_concat_self(&compilation, &tempCompilation);
						continue;
				...
				do {
					...
					if (ZEPHIR_IS_LONG(&type, 307)) {
						...
						if (zephir_is_true(&blockMode)) {
							...
							if (Z_TYPE_P(&blockStatements) == IS_ARRAY) {
								...
								ZEPHIR_CALL_METHOD(&_80$$58, this_ptr, "_statementlist", &_33, 387, &blockStatements, &_81$$58);
								zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(NULL, &_96$$72, "__construct", &_7, 383, &_99$$72);
					zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compile)
{
	...
	if (Z_TYPE_P(&compiledPath) == IS_STRING) {
		...
		if (Z_TYPE_P(&compiledPath) == IS_OBJECT) {
			if (zephir_is_instance_of(&compiledPath, SL("Closure"))) {
