...
PHP_METHOD(Phalcon_Mvc_Collection, __construct)
{
	...
	ZEND_PARSE_PARAMETERS_START(0, 2)
		...
		Z_PARAM_OBJECT_OF_CLASS_OR_NULL(modelsManager, zephir_get_internal_ce(SL("phalcon\\mvc\\collection\\managerinterface")))
...
PHP_METHOD(Phalcon_Mvc_Collection, setEventsManager)
{
	...
	bool is_null_true = 1;
	ZEND_PARSE_PARAMETERS_START(1, 1)
		Z_PARAM_OBJECT_OF_CLASS(eventsManager, zephir_get_internal_ce(SL("phalcon\\mvc\\collection\\managerinterface")))
	ZEND_PARSE_PARAMETERS_END();
#endif
...
PHP_METHOD(Phalcon_Mvc_Collection, cloneResult)
{
	...
	bool is_null_true = 1;
	ZEND_PARSE_PARAMETERS_START(2, 2)
		Z_PARAM_OBJECT_OF_CLASS(collection, zephir_get_internal_ce(SL("phalcon\\mvc\\collectioninterface")))
...
PHP_METHOD(Phalcon_Mvc_Collection, _getResultset)
{
	...
	ZEPHIR_CALL_FUNCTION(&_6, "iterator_to_array", NULL, 292, &documentsCursor, &__$false);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Collection, _getGroupResultset)
{
	...
	ZEND_PARSE_PARAMETERS_START(3, 3)
		Z_PARAM_ZVAL(params)
		Z_PARAM_OBJECT_OF_CLASS(collection, zephir_get_internal_ce(SL("phalcon\\mvc\\collection")))
		Z_PARAM_ZVAL(connection)
	ZEND_PARSE_PARAMETERS_END();
#endif
...
PHP_METHOD(Phalcon_Mvc_Collection, save)
{
	...
	ZEPHIR_CALL_METHOD(&_3, this_ptr, "_presave", NULL, 293, &_4, &_5, &exists);
	zephir_check_call_status();
	if (ZEPHIR_IS_FALSE_IDENTICAL(&_3)) {
		RETURN_MM_BOOL(0);
	}
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "_postsave", NULL, 294, &_8, &_9, &exists);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Mvc_Collection, create)
{
	...
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "_presave", NULL, 293, &_0, &_3, &_4);
	zephir_check_call_status();
	if (ZEPHIR_IS_FALSE_IDENTICAL(&_2)) {
		RETURN_MM_BOOL(0);
	}
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "_postsave", NULL, 294, &_7, &_8, &_9);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Mvc_Collection, createIfNotExist)
{
	...
	ZEPHIR_CALL_FUNCTION(&keys, "array_flip", NULL, 295, &criteria);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&data, this_ptr, "toarray", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_5, "array_diff_key", NULL, 296, &keys, &data);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&query, "array_intersect_key", NULL, 297, &data, &keys);
	zephir_check_call_status();
	success = 0;
	ZEPHIR_INIT_VAR(&_6);
	zephir_create_array(&_6, 1, 0);
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "_postsave", NULL, 294, &_8, &_13, &_14);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Mvc_Collection, update)
{
	...
	zephir_read_property(&_0, this_ptr, ZEND_STRL("_dependencyInjector"), PH_NOISY_CC | PH_READONLY);
	zephir_read_static_property_ce(&_3, phalcon_mvc_collection_ce, SL("_disableEvents"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "_presave", NULL, 293, &_0, &_3, &exists);
	zephir_check_call_status();
	if (ZEPHIR_IS_FALSE_IDENTICAL(&_2)) {
		RETURN_MM_BOOL(0);
	}
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "_postsave", NULL, 294, &_7, &_8, &exists);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Mvc_Collection, addBehavior)
{
	...
	bool is_null_true = 1;
	ZEND_PARSE_PARAMETERS_START(1, 1)
		Z_PARAM_OBJECT_OF_CLASS(behavior, zephir_get_internal_ce(SL("phalcon\\mvc\\collection\\behaviorinterface")))
	ZEND_PARSE_PARAMETERS_END();
#endif
...
PHP_METHOD(Phalcon_Mvc_Collection, toArray)
{
	...
	array_init(&data);
	ZEPHIR_CALL_FUNCTION(&_0, "get_object_vars", NULL, 182, this_ptr);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Collection, __unserialize)
{
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zephir_fcall_cache_entry *_0 = NULL;
	zval *data_param = NULL, dependencyInjector, manager, key, value, _1$$3, *_2$$3, _3$$3;
	zval data;
	zval *this_ptr = getThis();
	...
	if (1 == 1) {
		...
		zephir_check_call_status();
		if (Z_TYPE_P(&dependencyInjector) != IS_OBJECT) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_collection_exception_ce, "A dependency injector container is required to obtain the services related to the ODM", "phalcon/mvc/collection.zep", 1673);
			return;
		}
		zephir_update_property_zval(this_ptr, ZEND_STRL("_dependencyInjector"), &dependencyInjector);
		ZEPHIR_INIT_VAR(&_1$$3);
		...
		if (Z_TYPE_P(&manager) != IS_OBJECT) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_collection_exception_ce, "The injected service 'collectionManager' is not valid", "phalcon/mvc/collection.zep", 1686);
			return;
		}
		zephir_update_property_zval(this_ptr, ZEND_STRL("_modelsManager"), &manager);
		zephir_is_iterable(&data, 0, "phalcon/mvc/collection.zep", 1700);
