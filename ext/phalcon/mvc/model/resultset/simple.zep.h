...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_mvc_model_resultset_simple__serialize, 0, 0, IS_ARRAY, 0)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(phalcon_mvc_model_resultset_simple_method_entry) {
	...
	PHP_ME(Phalcon_Mvc_Model_Resultset_Simple, _serialize, arginfo_phalcon_mvc_model_resultset_simple__serialize, ZEND_ACC_PUBLIC)
