	...
	if (Z_TYPE_P(&_0) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_0), _4)
		{
			...
			if (Z_TYPE_P(&_37$$3) != IS_NULL) {
				...
				ZVAL_STRING(&_40$$26, "");
				ZEPHIR_CALL_FUNCTION(&_41$$26, "preg_replace", &_42, 39, &_39$$26, &_40$$26, &_38$$26);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_FUNCTION(&_44$$26, "strcasecmp", &_45, 18, &_43$$26, &_39$$26);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (Z_TYPE_P(&_80$$28) != IS_NULL) {
					...
					ZVAL_STRING(&_83$$51, "");
					ZEPHIR_CALL_FUNCTION(&_84$$51, "preg_replace", &_42, 39, &_82$$51, &_83$$51, &_81$$51);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_FUNCTION(&_86$$51, "strcasecmp", &_45, 18, &_85$$51, &_82$$51);
					zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(NULL, &_87$$28, "__construct", &_47, 159, &columnName, &definition);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Adapter_Pdo_Postgresql, createTable)
{
	...
	if (zephir_fast_count_int(&queries) > 1) {
		...
		if (EG(exception)) {
			...
			Z_ADDREF_P(&_6$$5);
			if (zephir_is_instance_of(&_6$$5, SL("Exception"))) {
...
PHP_METHOD(Phalcon_Db_Adapter_Pdo_Postgresql, modifyColumn)
{
	...
	if (zephir_fast_count_int(&queries) > 1) {
		...
		if (EG(exception)) {
			...
			Z_ADDREF_P(&_6$$3);
			if (zephir_is_instance_of(&_6$$3, SL("Exception"))) {
				zend_clear_exception();
