...
PHP_METHOD(Phalcon_Http_Request, get)
{
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "gethelper", NULL, 211, &_REQUEST, &name, filters, defaultValue, &_0, &_1);
...
PHP_METHOD(Phalcon_Http_Request, getPost)
{
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "gethelper", NULL, 211, &_POST, &name, filters, defaultValue, &_0, &_1);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Http_Request, getPut)
{
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "gethelper", NULL, 211, &put, &name, filters, defaultValue, &_5, &_6);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Http_Request, getQuery)
{
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "gethelper", NULL, 211, &_GET, &name, filters, defaultValue, &_0, &_1);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Http_Request, getJsonRawBody)
{
	...
	ZEPHIR_CALL_FUNCTION(&_1, "json_last_error", NULL, 214);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getHttpHost)
{
	...
	if (_3) {
		...
		if (zephir_memnstr_str(&host, SL(":"), "phalcon/http/request.zep", 507)) {
			...
			ZVAL_STRING(&_6$$6, "");
			ZEPHIR_CALL_FUNCTION(&_7$$6, "preg_replace", NULL, 39, &_5$$6, &_6$$6, &host);
			zephir_check_call_status();
		...
		ZVAL_STRING(&_9$$5, "");
		ZEPHIR_CALL_FUNCTION(&_10$$5, "preg_replace", NULL, 39, &_8$$5, &_9$$5, &host);
		zephir_check_call_status();
		...
		if (!ZEPHIR_IS_IDENTICAL(&_11$$5, &_10$$5)) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_12$$7, "__construct", NULL, 216, &_13$$7);
			zephir_check_call_status();
	...
	zephir_cast_to_string(&_14, &host);
	RETURN_CTOR(&_14);
}
...
PHP_METHOD(Phalcon_Http_Request, getMethod)
{
	...
	if (ZEPHIR_IS_IDENTICAL(&_0, &returnMethod)) {
		...
		ZEPHIR_CALL_METHOD(&overridedMethod, this_ptr, "getheader", NULL, 217, &_1$$5);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(methods) == IS_ARRAY) {
		...
		if (Z_TYPE_P(methods) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(methods), _4$$5)
			{
				...
				ZEPHIR_CALL_METHOD(&_6$$6, this_ptr, "ismethod", &_8, 219, &method, &_7$$6);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&_9$$8, this_ptr, "ismethod", &_8, 219, &method, &_10$$8);
					zephir_check_call_status();
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&files), _0)
		{
			...
			if (zephir_array_isset_string_fetch(&error, &file, SL("error"), 0)) {
				...
				if (Z_TYPE_P(&error) == IS_ARRAY) {
					...
					ZEPHIR_CALL_METHOD(&_3$$8, this_ptr, "hasfilehelper", &_5, 220, &error, &_4$$8);
					zephir_check_call_status();
			...
			zephir_check_call_status();
				...
				if (zephir_array_isset_string_fetch(&error, &file, SL("error"), 0)) {
					...
					if (Z_TYPE_P(&error) == IS_ARRAY) {
						...
						ZEPHIR_CALL_METHOD(&_7$$13, this_ptr, "hasfilehelper", &_5, 220, &error, &_8$$13);
						zephir_check_call_status();
	...
	if (Z_TYPE_P(data) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(data), _0)
		{
			...
			if (Z_TYPE_P(&value) == IS_ARRAY) {
				...
				ZEPHIR_CALL_METHOD(&_3$$7, this_ptr, "hasfilehelper", &_5, 220, &value, &_4$$7);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (Z_TYPE_P(&value) == IS_ARRAY) {
					...
					ZEPHIR_CALL_METHOD(&_7$$11, this_ptr, "hasfilehelper", &_5, 220, &value, &_8$$11);
					zephir_check_call_status();
		...
		if (Z_TYPE_P(&superFiles) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&superFiles), _2$$3, _3$$3, _0$$3)
			{
				...
				if (Z_TYPE_P(&_4$$4) == IS_ARRAY) {
					...
					ZEPHIR_CALL_METHOD(&smoothInput, this_ptr, "smoothfiles", &_10, 221, &_5$$5, &_6$$5, &_7$$5, &_8$$5, &_9$$5, &prefix);
					zephir_check_call_status();
						...
						while (1) {
							...
							zephir_check_call_status();
								...
								if (_19$$8) {
									...
									ZEPHIR_CALL_METHOD(NULL, &_23$$9, "__construct", &_18, 222, &dataFile, &_24$$9);
									zephir_check_call_status();
					...
					if (_25$$10) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_27$$11, "__construct", &_18, 222, &input, &prefix);
						zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					if (Z_TYPE_P(&_28$$12) == IS_ARRAY) {
						...
						ZEPHIR_CALL_METHOD(&smoothInput, this_ptr, "smoothfiles", &_10, 221, &_29$$13, &_30$$13, &_31$$13, &_32$$13, &_33$$13, &prefix);
						zephir_check_call_status();
						zephir_is_iterable(&smoothInput, 0, "phalcon/http/request.zep", 900);
						if (Z_TYPE_P(&smoothInput) == IS_ARRAY) {
							ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&smoothInput), _34$$13)
							{
								...
								if (_36$$14) {
									...
									ZEPHIR_CALL_METHOD(NULL, &_40$$15, "__construct", &_18, 222, &dataFile, &_41$$15);
									zephir_check_call_status();
							...
							while (1) {
								...
								zephir_check_call_status();
									...
									if (_42$$16) {
										...
										ZEPHIR_CALL_METHOD(NULL, &_46$$17, "__construct", &_18, 222, &dataFile, &_47$$17);
										zephir_check_call_status();
						...
						if (_48$$18) {
							...
							ZEPHIR_CALL_METHOD(NULL, &_50$$19, "__construct", &_18, 222, &input, &prefix);
							zephir_check_call_status();
	...
	if (Z_TYPE_P(&names) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&names), _2, _3, _0)
		{
			...
			if (Z_TYPE_P(&name) == IS_ARRAY) {
				...
				ZEPHIR_CALL_METHOD(&parentFiles, this_ptr, "smoothfiles", &_11, 221, &_6$$5, &_7$$5, &_8$$5, &_9$$5, &_10$$5, &p);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (Z_TYPE_P(&name) == IS_ARRAY) {
					...
					ZEPHIR_CALL_METHOD(&parentFiles, this_ptr, "smoothfiles", &_11, 221, &_16$$10, &_17$$10, &_18$$10, &_19$$10, &_20$$10, &p);
					zephir_check_call_status();
					zephir_is_iterable(&parentFiles, 0, "phalcon/http/request.zep", 948);
					if (Z_TYPE_P(&parentFiles) == IS_ARRAY) {
	...
	if (Z_TYPE_P(&_SERVER) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_SERVER), _2, _3, _0)
		{
			...
			if (zephir_start_with_str(&name, SL("HTTP_"))) {
				...
				ZEPHIR_CALL_FUNCTION(&name, "ucwords", &_10, 223, &_4$$4);
				zephir_check_call_status();
			...
			if (zephir_array_isset(&contentHeaders, &name)) {
				...
				ZEPHIR_CALL_FUNCTION(&name, "ucwords", &_10, 223, &_15$$5);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				if (zephir_start_with_str(&name, SL("HTTP_"))) {
					...
					ZEPHIR_CALL_FUNCTION(&name, "ucwords", &_10, 223, &_22$$7);
					zephir_check_call_status();
				...
				if (zephir_array_isset(&contentHeaders, &name)) {
					...
					ZEPHIR_CALL_FUNCTION(&name, "ucwords", &_10, 223, &_32$$8);
					zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getAcceptableContent)
{
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "_getqualityheader", NULL, 224, &_0, &_1);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Http_Request, getBestAccept)
{
	...
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "accept");
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "_getbestquality", NULL, 225, &_0, &_1);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Http_Request, _getQualityHeader)
{
	...
	ZVAL_LONG(&_2, -1);
	ZVAL_LONG(&_3, 1);
	ZEPHIR_CALL_FUNCTION(&_4, "preg_split", NULL, 226, &_1, &serverValue, &_2, &_3);
	zephir_check_call_status();
	zephir_is_iterable(&_4, 0, "phalcon/http/request.zep", 1266);
	if (Z_TYPE_P(&_4) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_4), _5)
		{
			...
			ZVAL_LONG(&_9$$3, -1);
			ZVAL_LONG(&_10$$3, 1);
			ZEPHIR_CALL_FUNCTION(&_11$$3, "preg_split", NULL, 226, &_8$$3, &_7$$3, &_9$$3, &_10$$3);
			zephir_check_call_status();
			zephir_is_iterable(&_11$$3, 0, "phalcon/http/request.zep", 1263);
			if (Z_TYPE_P(&_11$$3) == IS_ARRAY) {
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_11$$3), _12$$3)
				{
					...
					if (!ZEPHIR_IS_FALSE_IDENTICAL(&_15$$4)) {
						...
						zephir_array_fetch_long(&_16$$5, &split, 0, PH_NOISY | PH_READONLY, "phalcon/http/request.zep", 1252);
						if (ZEPHIR_IS_STRING_IDENTICAL(&_16$$5, "q")) {
							ZEPHIR_OBS_NVAR(&_17$$6);
							zephir_array_fetch_long(&_17$$6, &split, 1, PH_NOISY, "phalcon/http/request.zep", 1253);
							...
							zephir_array_fetch_long(&_19$$7, &split, 1, PH_NOISY | PH_READONLY, "phalcon/http/request.zep", 1255);
							ZEPHIR_OBS_NVAR(&_20$$7);
							zephir_array_fetch_long(&_20$$7, &split, 0, PH_NOISY, "phalcon/http/request.zep", 1255);
				...
				while (1) {
					...
					zephir_check_call_status();
						...
						if (!ZEPHIR_IS_FALSE_IDENTICAL(&_23$$9)) {
							ZEPHIR_INIT_NVAR(&split);
							zephir_fast_explode_str(&split, SL("="), &headerPart, 2 );
							zephir_array_fetch_long(&_24$$10, &split, 0, PH_NOISY | PH_READONLY, "phalcon/http/request.zep", 1252);
							if (ZEPHIR_IS_STRING_IDENTICAL(&_24$$10, "q")) {
								ZEPHIR_OBS_NVAR(&_25$$11);
								zephir_array_fetch_long(&_25$$11, &split, 1, PH_NOISY, "phalcon/http/request.zep", 1253);
								...
								zephir_array_fetch_long(&_27$$12, &split, 1, PH_NOISY | PH_READONLY, "phalcon/http/request.zep", 1255);
								ZEPHIR_OBS_NVAR(&_28$$12);
								zephir_array_fetch_long(&_28$$12, &split, 0, PH_NOISY, "phalcon/http/request.zep", 1255);
			...
			ZEPHIR_INIT_NVAR(&headerPart);
			zephir_array_append(&returnedParts, &headerParts, PH_SEPARATE, "phalcon/http/request.zep", 1263);
		} ZEND_HASH_FOREACH_END();
	} else {
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZVAL_LONG(&_32$$14, -1);
				ZVAL_LONG(&_33$$14, 1);
				ZEPHIR_CALL_FUNCTION(&_34$$14, "preg_split", NULL, 226, &_31$$14, &_30$$14, &_32$$14, &_33$$14);
				zephir_check_call_status();
				zephir_is_iterable(&_34$$14, 0, "phalcon/http/request.zep", 1263);
				if (Z_TYPE_P(&_34$$14) == IS_ARRAY) {
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_34$$14), _35$$14)
					{
						...
						if (!ZEPHIR_IS_FALSE_IDENTICAL(&_38$$15)) {
							ZEPHIR_INIT_NVAR(&split);
							zephir_fast_explode_str(&split, SL("="), &headerPart, 2 );
							zephir_array_fetch_long(&_39$$16, &split, 0, PH_NOISY | PH_READONLY, "phalcon/http/request.zep", 1252);
							if (ZEPHIR_IS_STRING_IDENTICAL(&_39$$16, "q")) {
								ZEPHIR_OBS_NVAR(&_40$$17);
								zephir_array_fetch_long(&_40$$17, &split, 1, PH_NOISY, "phalcon/http/request.zep", 1253);
								...
								zephir_array_fetch_long(&_42$$18, &split, 1, PH_NOISY | PH_READONLY, "phalcon/http/request.zep", 1255);
								ZEPHIR_OBS_NVAR(&_43$$18);
								zephir_array_fetch_long(&_43$$18, &split, 0, PH_NOISY, "phalcon/http/request.zep", 1255);
					...
					while (1) {
						...
						zephir_check_call_status();
							...
							if (!ZEPHIR_IS_FALSE_IDENTICAL(&_46$$20)) {
								ZEPHIR_INIT_NVAR(&split);
								zephir_fast_explode_str(&split, SL("="), &headerPart, 2 );
								zephir_array_fetch_long(&_47$$21, &split, 0, PH_NOISY | PH_READONLY, "phalcon/http/request.zep", 1252);
								if (ZEPHIR_IS_STRING_IDENTICAL(&_47$$21, "q")) {
									ZEPHIR_OBS_NVAR(&_48$$22);
									zephir_array_fetch_long(&_48$$22, &split, 1, PH_NOISY, "phalcon/http/request.zep", 1253);
									...
									zephir_array_fetch_long(&_50$$23, &split, 1, PH_NOISY | PH_READONLY, "phalcon/http/request.zep", 1255);
									ZEPHIR_OBS_NVAR(&_51$$23);
									zephir_array_fetch_long(&_51$$23, &split, 0, PH_NOISY, "phalcon/http/request.zep", 1255);
