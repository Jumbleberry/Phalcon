...
PHP_METHOD(Phalcon_Logger_Adapter_Syslog, __construct)
{
	...
	if (zephir_is_true(name)) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "openlog", NULL, 287, name, &option, &facility);
...
PHP_METHOD(Phalcon_Logger_Adapter_Syslog, logInternal)
{
	...
	ZEPHIR_CALL_FUNCTION(NULL, "syslog", NULL, 288, &_3, &_4);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Logger_Adapter_Syslog, close)
{
	...
	ZEPHIR_RETURN_CALL_FUNCTION("closelog", NULL, 289);
	zephir_check_call_status();
	RETURN_MM();
}
