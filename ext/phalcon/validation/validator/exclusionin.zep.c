...
PHP_METHOD(Phalcon_Validation_Validator_ExclusionIn, validate)
{
	...
	ZEPHIR_CALL_FUNCTION(&_4, "in_array", NULL, 366, &value, &domain, &strict);
	zephir_check_call_status();
	if (zephir_is_true(&_4)) {
		...
		ZEPHIR_CALL_FUNCTION(&_6$$9, "strtr", NULL, 26, &message, &replacePairs);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_7$$9);
		ZVAL_STRING(&_7$$9, "ExclusionIn");
		ZEPHIR_CALL_METHOD(NULL, &_5$$9, "__construct", NULL, 443, &_6$$9, &field, &_7$$9, &code);
		zephir_check_call_status();
