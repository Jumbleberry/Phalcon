...
PHP_METHOD(Phalcon_Validation_Validator_Date, validate)
{
	...
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "checkdate", NULL, 449, &value, &format);
	zephir_check_call_status();
	if (!(zephir_is_true(&_2))) {
		...
		ZEPHIR_CALL_FUNCTION(&_4$$5, "strtr", NULL, 26, &message, &replacePairs);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_5$$5);
		ZVAL_STRING(&_5$$5, "Date");
		ZEPHIR_CALL_METHOD(NULL, &_3$$5, "__construct", NULL, 443, &_4$$5, &field, &_5$$5, &code);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Validation_Validator_Date, checkDate)
{
	...
	if (_2) {
		zephir_array_fetch_string(&_3, &errors, SL("warning_count"), PH_NOISY | PH_READONLY, "phalcon/validation/validator/date.zep", 120);
		_4 = ZEPHIR_GT_LONG(&_3, 0);
		if (!(_4)) {
			zephir_array_fetch_string(&_5, &errors, SL("error_count"), PH_NOISY | PH_READONLY, "phalcon/validation/validator/date.zep", 120);
