...
PHP_METHOD(Phalcon_Validation_Validator_Alnum, validate)
{
	...
	ZEPHIR_CALL_FUNCTION(&_0, "ctype_alnum", NULL, 445, &value);
	zephir_check_call_status();
	if (!(zephir_is_true(&_0))) {
		...
		ZEPHIR_CALL_FUNCTION(&_2$$3, "strtr", NULL, 26, &message, &replacePairs);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_3$$3);
		ZVAL_STRING(&_3$$3, "Alnum");
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 443, &_2$$3, &field, &_3$$3, &code);
		zephir_check_call_status();
