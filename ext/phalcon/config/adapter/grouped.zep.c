		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&arrayConfig), _2)
		{
			...
			if (_4$$3) {
				...
				if (ZEPHIR_IS_IDENTICAL(&_6$$5, &defaultAdapter)) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_7$$6, "__construct", &_8, 134);
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_9$$6, &_7$$6, "load", &_10, 135, &configName);
					zephir_check_call_status();
			...
			if (ZEPHIR_IS_IDENTICAL(&_13$$3, &_12$$3)) {
				if (!(zephir_array_isset_string(&configInstance, SL("config")))) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_14$$9, "__construct", &_16, 4, &_15$$9);
					zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(NULL, &configInstance, "__construct", &_18, 15, &configArray, &_17$$8);
				zephir_check_call_status();
			} else {
				ZEPHIR_INIT_NVAR(&_19$$10);
				object_init_ex(&_19$$10, phalcon_config_configfactory_ce);
				ZEPHIR_CALL_METHOD(NULL, &_19$$10, "__construct", &_8, 134);
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_20$$10, &_19$$10, "load", &_10, 135, &configInstance);
				zephir_check_call_status();
			...
			zephir_check_call_status();
				...
				if (_21$$11) {
					...
					if (ZEPHIR_IS_IDENTICAL(&_22$$13, &defaultAdapter)) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_23$$14, "__construct", &_8, 134);
						zephir_check_call_status();
						ZEPHIR_CALL_METHOD(&_24$$14, &_23$$14, "load", &_10, 135, &configName);
						zephir_check_call_status();
				...
				if (ZEPHIR_IS_IDENTICAL(&_27$$11, &_26$$11)) {
					if (!(zephir_array_isset_string(&configInstance, SL("config")))) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_28$$17, "__construct", &_16, 4, &_29$$17);
						zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(NULL, &configInstance, "__construct", &_18, 15, &configArray, &_30$$16);
					zephir_check_call_status();
				} else {
					ZEPHIR_INIT_NVAR(&_31$$18);
					object_init_ex(&_31$$18, phalcon_config_configfactory_ce);
					ZEPHIR_CALL_METHOD(NULL, &_31$$18, "__construct", &_8, 134);
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_32$$18, &_31$$18, "load", &_10, 135, &configInstance);
					zephir_check_call_status();
