...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, check)
{
	...
	ZEPHIR_CALL_FUNCTION(&_3, "defined", NULL, 35, &_2);
	zephir_check_call_status();
	if (zephir_is_true(&_3)) {
		ZEPHIR_INIT_VAR(&_4$$5);
		ZVAL_STRING(&_4$$5, "Imagick::IMAGICK_EXTNUM");
		ZEPHIR_CALL_FUNCTION(&_5$$5, "constant", NULL, 36, &_4$$5);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, __construct)
{
	...
	if ((zephir_file_exists(&_2) == SUCCESS)) {
		...
		if (!(zephir_is_true(&_12$$4))) {
			...
			ZEPHIR_CALL_FUNCTION(&_15$$6, "constant", NULL, 36, &_14$$6);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _reflection)
{
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_20$$7, "constant", &_21, 36, &_19$$7);
		zephir_check_call_status();
		ZVAL_LONG(&_22$$7, 0);
		ZVAL_LONG(&_23$$7, 0);
		...
		ZEPHIR_CALL_FUNCTION(&_25$$7, "constant", &_21, 36, &_19$$7);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_19$$7);
		ZVAL_STRING(&_19$$7, "Imagick::CHANNEL_ALPHA");
		ZEPHIR_CALL_FUNCTION(&_26$$7, "constant", &_21, 36, &_19$$7);
		zephir_check_call_status();
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_37$$10, "constant", &_21, 36, &_36$$10);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_45$$10, "constant", &_21, 36, &_36$$10);
		zephir_check_call_status();
		ZVAL_LONG(&_46$$10, 0);
		ZVAL_LONG(&_47$$10, 0);
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_51$$13, "constant", &_21, 36, &_50$$13);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _watermark)
{
	...
	bool is_null_true = 1;
	ZEND_PARSE_PARAMETERS_START(4, 4)
		Z_PARAM_OBJECT_OF_CLASS(image, zephir_get_internal_ce(SL("phalcon\\image\\adapter")))
		Z_PARAM_LONG(offsetX)
		Z_PARAM_LONG(offsetY)
		Z_PARAM_LONG(opacity)
	ZEND_PARSE_PARAMETERS_END();
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_6$$5, "constant", &_7, 36, &_5$$5);
		zephir_check_call_status();
			...
			if (Z_TYPE_P(offsetY) == IS_LONG) {
				...
				if (zephir_is_true(offsetX)) {
					...
					if (y < 0) {
						...
						ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 36, &_11$$17);
						zephir_check_call_status();
					} else {
						ZVAL_LONG(offsetX, 0);
						ZEPHIR_INIT_VAR(&_12$$18);
						ZVAL_STRING(&_12$$18, "Imagick::GRAVITY_NORTHEAST");
						ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 36, &_12$$18);
						zephir_check_call_status();
					}
				} else {
					ZEPHIR_INIT_NVAR(offsetX);
					if (y < 0) {
						...
						ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 36, &_13$$20);
						zephir_check_call_status();
					} else {
						ZVAL_LONG(offsetX, 0);
						ZEPHIR_INIT_VAR(&_14$$21);
						ZVAL_STRING(&_14$$21, "Imagick::GRAVITY_NORTH");
						ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 36, &_14$$21);
						zephir_check_call_status();
					}
				}
			}
				...
				if (((Z_TYPE_P(offsetY) == IS_TRUE || Z_TYPE_P(offsetY) == IS_FALSE) == 1)) {
					if (zephir_is_true(offsetY)) {
						...
						if (x < 0) {
							...
							ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 36, &_15$$27);
							zephir_check_call_status();
						} else {
							ZVAL_LONG(offsetY, 0);
							ZEPHIR_INIT_VAR(&_16$$28);
							ZVAL_STRING(&_16$$28, "Imagick::GRAVITY_SOUTH");
							ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 36, &_16$$28);
							zephir_check_call_status();
						}
					} else {
						ZEPHIR_INIT_NVAR(offsetY);
						if (x < 0) {
							...
							ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 36, &_17$$30);
							zephir_check_call_status();
						} else {
							ZVAL_LONG(offsetY, 0);
							ZEPHIR_INIT_VAR(&_18$$31);
							ZVAL_STRING(&_18$$31, "Imagick::GRAVITY_WEST");
							ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 36, &_18$$31);
							zephir_check_call_status();
						}
					}
				} else {
					if (Z_TYPE_P(offsetY) == IS_LONG) {
						...
						if (x < 0) {
							...
							if (y < 0) {
								...
								ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 36, &_19$$35);
								zephir_check_call_status();
							} else {
								ZVAL_LONG(offsetX, (x * -1));
								ZEPHIR_INIT_VAR(&_20$$36);
								ZVAL_STRING(&_20$$36, "Imagick::GRAVITY_NORTHEAST");
								ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 36, &_20$$36);
								zephir_check_call_status();
							}
						} else {
							ZEPHIR_INIT_NVAR(offsetX);
							if (y < 0) {
								...
								ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 36, &_21$$38);
								zephir_check_call_status();
							} else {
								ZVAL_LONG(offsetX, 0);
								ZEPHIR_INIT_VAR(&_22$$39);
								ZVAL_STRING(&_22$$39, "Imagick::GRAVITY_NORTHWEST");
								ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 36, &_22$$39);
								zephir_check_call_status();
							}
						}
					}
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _mask)
{
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_6$$3, "constant", &_7, 36, &_5$$3);
		zephir_check_call_status();
		ZVAL_LONG(&_8$$3, 0);
		ZVAL_LONG(&_9$$3, 0);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _background)
{
	...
	while (1) {
		...
		if (!(zephir_is_true(&_7$$3))) {
			...
			ZEPHIR_CALL_FUNCTION(&_10$$4, "constant", &_11, 36, &_9$$4);
			zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_15$$3, "constant", &_11, 36, &_14$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_14$$3);
		ZVAL_STRING(&_14$$3, "Imagick::CHANNEL_ALPHA");
		ZEPHIR_CALL_FUNCTION(&_16$$3, "constant", &_11, 36, &_14$$3);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_22$$3, "constant", &_11, 36, &_14$$3);
		zephir_check_call_status();
		ZVAL_LONG(&_23$$3, 0);
		ZVAL_LONG(&_24$$3, 0);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _save)
{
	...
	if (ZEPHIR_IS_LONG(&_8, 0)) {
		...
		ZVAL_STRING(&_10$$3, "w");
		ZEPHIR_CALL_FUNCTION(&fp, "fopen", NULL, 282, &file, &_10$$3);
		zephir_check_call_status();
		...
		if (_14$$4) {
			...
			ZEPHIR_CALL_FUNCTION(&_18$$5, "constant", NULL, 36, &_17$$5);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _render)
{
	...
	if (ZEPHIR_IS_LONG_IDENTICAL(&_4, 0)) {
		...
		if (_7$$4) {
			...
			ZEPHIR_CALL_FUNCTION(&_10$$5, "constant", NULL, 36, &_9$$5);
			zephir_check_call_status();
