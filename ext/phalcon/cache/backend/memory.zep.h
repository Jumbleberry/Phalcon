...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_cache_backend_memory__serialize, 0, 0, IS_ARRAY, 0)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(phalcon_cache_backend_memory_method_entry) {
	...
	PHP_ME(Phalcon_Cache_Backend_Memory, _serialize, arginfo_phalcon_cache_backend_memory__serialize, ZEND_ACC_PUBLIC)
